...
// Function to mask an account number (code is not fully visible)
export const maskAccountNumber = (accountNumber) => {
    ...
    // Assuming we mask all but last 4 digits
    // return accountNumber.replace(/\d(?=\d{4})/g, "*");
};

// Format a number as currency based on user's local settings
