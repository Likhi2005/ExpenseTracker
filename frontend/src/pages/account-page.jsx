      ...
      <div className='w-full py-10'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-4'>
            <button
              ...
              className='py-1.5 px-2 rounded bg-black dark:bg-violet-600 text-white dark:text-white flex items-center justify-between'
            >
              <MdAdd size={22} />
              <sapn className=''>Add</sapn>
            </button>
          </div>
        </div>
        ...
        {data?.length == 0 ? (
          <>
            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 py-10 gap-6'>
            {data?.map((acc, index) => (
              <div
                key={index}
                className='w-full flex flex-col justify-between h-48 gap-3 bg-gray-50 dark:bg-slate-800 p-3 rounded shadow'
              >
                <div>
