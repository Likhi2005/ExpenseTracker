                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <span className="text-gray-600 text-sm 2xl:text-base">{maskAccountNumber(item.account_name)}</span>
                            </div>
                        </div>

                        <div>
                            <p className="text-lg 2xl:text-xl text-black dark:text-gray-400 font-medium">{formatCurrency(item?.account_balance)}</p>
